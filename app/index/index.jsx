...
import { popular_papers } from '../../src/api/popular';
import { recent_papers } from '../../src/api/recent';
    ...
    <ScrollView style={styles.container}>
      ...
      <View style={styles.flatListWrapper}>
        <FlatList
          ...
          data={popular_papers} // Dummy data for now
        />
      </View>
      <TouchableOpacity style={styles.subHeaderContainer}>
      ...
      <View style={styles.flatListWrapper}>
        <FlatList
          ...
          ItemSeparatorComponent={<View style={{ width: 16 }} />}
          ListFooterComponent={<View style={{ width: 16 }} />}
          data={recent_papers} // Dummy data for now
        />
      </View>
